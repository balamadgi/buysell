...
public class ProductController {
    ...
    public User user(Principal principal) {
        return productService.getUserByPrincipal(principal);
    }
    ...
    public String createProduct(@RequestParam("file1") MultipartFile file1,
        ...
        if (bindingResult.hasErrors()) {
            ...
            return "redirect:/user/" + productService.getUserByPrincipal(principal).getId();
        }
    }
    ...
    public String editProduct(@PathVariable Long id, Model model, Principal principal) {
        ...
        model.addAttribute("checkUser", product.getUser() == productService.getUserByPrincipal(principal));
